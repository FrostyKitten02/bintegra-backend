...
public class PackageOfferServiceHttp {
	...
	public static java.util.List<si.bintegra.sp.model.PackageOffer>
		findActiveByPackageId(HttpPrincipal httpPrincipal, Long id) {

		try {
			MethodKey methodKey = new MethodKey(
				PackageOfferServiceUtil.class, "findActiveByPackageId",
				_findActiveByPackageIdParameterTypes0);
	...
	private static final Class<?>[] _findActiveByPackageIdParameterTypes0 =
