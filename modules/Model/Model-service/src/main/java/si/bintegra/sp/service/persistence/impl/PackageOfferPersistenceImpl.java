...
public class PackageOfferPersistenceImpl
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (PackageOffer packageOffer : list) {
					if (active != packageOffer.isActive()) {
						list = null;
	...
	private FinderPath _finderPathWithPaginationFindBypackageId;
	private FinderPath _finderPathWithoutPaginationFindBypackageId;
	private FinderPath _finderPathCountBypackageId;
	 ...
	 */
	@Override
	public List<PackageOffer> findBypackageId(long packageId) {
	 ...
	 */
	@Override
	public List<PackageOffer> findBypackageId(
	...
	public List<PackageOffer> findBypackageId(
		...
		return findBypackageId(packageId, start, end, orderByComparator, true);
	}
	...
	public List<PackageOffer> findBypackageId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBypackageId;
				finderArgs = new Object[] {packageId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBypackageId;
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (PackageOffer packageOffer : list) {
					if (packageId != packageOffer.getPackageId()) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_PACKAGEID_PACKAGEID_2);
	...
	public PackageOffer findBypackageId_First(
		...
		PackageOffer packageOffer = fetchBypackageId_First(
	...
	public PackageOffer fetchBypackageId_First(
		...
		List<PackageOffer> list = findBypackageId(
			packageId, 0, 1, orderByComparator);
	...
	public PackageOffer findBypackageId_Last(
		...
		PackageOffer packageOffer = fetchBypackageId_Last(
			packageId, orderByComparator);
	...
	public PackageOffer fetchBypackageId_Last(
		...
		List<PackageOffer> list = findBypackageId(
			packageId, count - 1, count, orderByComparator);
	...
	public PackageOffer[] findBypackageId_PrevAndNext(
		...
		try {
			...
			array[0] = getBypackageId_PrevAndNext(
				session, packageOffer, packageId, orderByComparator, true);

			array[1] = packageOffer;

			array[2] = getBypackageId_PrevAndNext(
				session, packageOffer, packageId, orderByComparator, false);
	...
	protected PackageOffer getBypackageId_PrevAndNext(
		Session session, PackageOffer packageOffer, long packageId,
		OrderByComparator<PackageOffer> orderByComparator, boolean previous) {
	...
	public int countBypackageId(long packageId) {
		FinderPath finderPath = _finderPathCountBypackageId;
	...
	private static final String _FINDER_COLUMN_PACKAGEID_PACKAGEID_2 =
		"packageOffer.packageId = ?";

	private FinderPath _finderPathWithPaginationFindBypackageIdAndActive;
	private FinderPath _finderPathWithoutPaginationFindBypackageIdAndActive;
	private FinderPath _finderPathCountBypackageIdAndActive;
	 ...
	 */
	@Override
	public List<PackageOffer> findBypackageIdAndActive(
		long packageId, boolean active) {

		return findBypackageIdAndActive(
			packageId, active, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<PackageOffer> findBypackageIdAndActive(
		...
		return findBypackageIdAndActive(packageId, active, start, end, null);
	}
	...
	public List<PackageOffer> findBypackageIdAndActive(
		...
		return findBypackageIdAndActive(
			packageId, active, start, end, orderByComparator, true);
	}
	...
	public List<PackageOffer> findBypackageIdAndActive(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindBypackageIdAndActive;
				finderArgs = new Object[] {packageId, active};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBypackageIdAndActive;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_PACKAGEIDANDACTIVE_PACKAGEID_2);

			sb.append(_FINDER_COLUMN_PACKAGEIDANDACTIVE_ACTIVE_2);
	...
	public PackageOffer findBypackageIdAndActive_First(
		...
		PackageOffer packageOffer = fetchBypackageIdAndActive_First(
	...
	public PackageOffer fetchBypackageIdAndActive_First(
		...
		List<PackageOffer> list = findBypackageIdAndActive(
			packageId, active, 0, 1, orderByComparator);
	...
	public PackageOffer findBypackageIdAndActive_Last(
		...
		PackageOffer packageOffer = fetchBypackageIdAndActive_Last(
			packageId, active, orderByComparator);
	...
	public PackageOffer fetchBypackageIdAndActive_Last(
		...
		int count = countBypackageIdAndActive(packageId, active);
		...
		List<PackageOffer> list = findBypackageIdAndActive(
			packageId, active, count - 1, count, orderByComparator);
	...
	public PackageOffer[] findBypackageIdAndActive_PrevAndNext(
		...
		try {
			...
			array[0] = getBypackageIdAndActive_PrevAndNext(
				session, packageOffer, packageId, active, orderByComparator,
				true);

			array[1] = packageOffer;

			array[2] = getBypackageIdAndActive_PrevAndNext(
				session, packageOffer, packageId, active, orderByComparator,
				false);
	...
	protected PackageOffer getBypackageIdAndActive_PrevAndNext(
		Session session, PackageOffer packageOffer, long packageId,
		boolean active, OrderByComparator<PackageOffer> orderByComparator,
		boolean previous) {
	...
	public void removeBypackageIdAndActive(long packageId, boolean active) {
		for (PackageOffer packageOffer :
				findBypackageIdAndActive(
					packageId, active, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int countBypackageIdAndActive(long packageId, boolean active) {
		FinderPath finderPath = _finderPathCountBypackageIdAndActive;
	...
	private static final String _FINDER_COLUMN_PACKAGEIDANDACTIVE_PACKAGEID_2 =
		"packageOffer.packageId = ? AND ";

	private static final String _FINDER_COLUMN_PACKAGEIDANDACTIVE_ACTIVE_2 =
		"packageOffer.active = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindBypackageId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBypackageId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"packageId"}, true);

		_finderPathWithoutPaginationFindBypackageId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBypackageId",
			new String[] {Long.class.getName()}, new String[] {"packageId"},
			true);

		_finderPathCountBypackageId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBypackageId",
			new String[] {Long.class.getName()}, new String[] {"packageId"},
			false);

		_finderPathWithPaginationFindBypackageIdAndActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBypackageIdAndActive",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
			},
			new String[] {"packageId", "active_"}, true);

		_finderPathWithoutPaginationFindBypackageIdAndActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findBypackageIdAndActive",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"packageId", "active_"}, true);

		_finderPathCountBypackageIdAndActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countBypackageIdAndActive",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"packageId", "active_"}, false);
