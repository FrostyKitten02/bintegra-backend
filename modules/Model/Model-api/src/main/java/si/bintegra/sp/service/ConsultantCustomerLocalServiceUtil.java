...
/**
 * Provides the local service utility for ConsultantCustomer. This utility wraps
 * <code>si.bintegra.sp.service.impl.ConsultantCustomerLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ConsultantCustomerLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>si.bintegra.sp.service.impl.ConsultantCustomerLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ConsultantCustomer addConsultantCustomer(
		ConsultantCustomer consultantCustomer) {

		return getService().addConsultantCustomer(consultantCustomer);
	}

	public static void assignConsultantToCustomer(Long customerUserId) {
		getService().assignConsultantToCustomer(customerUserId);
	}
	 ...
	 */
	public static ConsultantCustomer createConsultantCustomer(long id) {
		return getService().createConsultantCustomer(id);
	}
	 ...
	 */
	public static ConsultantCustomer deleteConsultantCustomer(
		ConsultantCustomer consultantCustomer) {

		return getService().deleteConsultantCustomer(consultantCustomer);
	}
	 ...
	 */
	public static ConsultantCustomer deleteConsultantCustomer(long id)
		throws PortalException {

		return getService().deleteConsultantCustomer(id);
	}
	...
	public static ConsultantCustomer fetchConsultantCustomer(long id) {
		return getService().fetchConsultantCustomer(id);
	}
	 ...
	 * @throws PortalException if a consultant customer with the primary key could not be found
	 */
	public static ConsultantCustomer getConsultantCustomer(long id)
		throws PortalException {
	 ...
	 */
	public static List<ConsultantCustomer> getConsultantCustomers(
		int start, int end) {

		return getService().getConsultantCustomers(start, end);
	}
	 ...
	 */
	public static int getConsultantCustomersCount() {
		return getService().getConsultantCustomersCount();
	}
	 ...
	 */
	public static ConsultantCustomer updateConsultantCustomer(
		ConsultantCustomer consultantCustomer) {

		return getService().updateConsultantCustomer(consultantCustomer);
	}

	public static ConsultantCustomerLocalService getService() {
		return _service;
	}

	private static volatile ConsultantCustomerLocalService _service;
