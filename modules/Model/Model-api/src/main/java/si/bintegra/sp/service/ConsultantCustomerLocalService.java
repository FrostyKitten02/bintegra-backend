...
/**
 * Provides the local service interface for ConsultantCustomer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConsultantCustomerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ConsultantCustomerLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>si.bintegra.sp.service.impl.ConsultantCustomerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the consultant customer local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ConsultantCustomerLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ConsultantCustomer addConsultantCustomer(
	...
	public ConsultantCustomer createConsultantCustomer(long id);
	...
	public ConsultantCustomer deleteConsultantCustomer(
		ConsultantCustomer consultantCustomer);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ConsultantCustomer deleteConsultantCustomer(long id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ConsultantCustomer fetchConsultantCustomer(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ConsultantCustomer> getConsultantCustomers(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ConsultantCustomer updateConsultantCustomer(
		ConsultantCustomer consultantCustomer);
